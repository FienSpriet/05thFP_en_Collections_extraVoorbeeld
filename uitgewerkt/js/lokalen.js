...
const zoekLokalen = () => {
  ...
  */
  const lokalenOpVerdieping = lokalen
    .map((lokaal) => {
      /*
        Kijk goed naar wat er gebeurd met lokaal als je hier GEEN shalow clone zou nemen van lokaal.
        Pas 
          const lokaalMetVerdieping = { ...lokaal };
        aan naar:
          const lokaalMetVerdieping = lokaal;
        En kijk goed in de console naar de OORSPRONKELIJKE lijst met lokalen.
        Om dit te vermijden maken we een shalow clone door {...lokaal} te plaatsen.
      */
      const lokaalMetVerdieping = { ...lokaal };
